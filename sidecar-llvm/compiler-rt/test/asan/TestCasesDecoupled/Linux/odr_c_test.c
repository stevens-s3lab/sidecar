...
// RUN: SIDECAR_BASE/sidecar/sidecar-monitors/sideasan/x86-64/monitor & not %run %t 2>&1 | FileCheck %s
...
// RUN: SIDECAR_BASE/sidecar/sidecar-monitors/sideasan/x86-64/monitor & %run %t 2>&1 | count 0
